...
<body>
    <div class="container py-3">
        ...
        // ------------------------------------------------------------------ ชั้น 3 ------------------------------------------------------------------
        // $result = pg_query("SELECT * from firedoor,firedoor_status WHERE firedoor.name = firedoor_status.sname and firedoor_status.floor = 'ชั้น 3'");.
        ...
        while ($row1 = pg_fetch_assoc($result1)) {
            ...
            if ($row11 == null) {
                ...
                echo "<div class='card-header py-3 bg-success' id='headchange'>";
                echo "<h4 class='my-0 fw-normal'>" . $row1['sname'] . "</h4>";
                echo "</div>";
                echo "<div class='card-body'>";
                echo "<img id='img' src='https://cdn0.iconfinder.com/data/icons/doors-filledoutline/64/FIRE_EXIT_DOOR-furniture_and_household-carpenter-house-home-128.png'><br><br>";
        ...
        // ------------------------------------------------------------------ ชั้น 4 ------------------------------------------------------------------
        // $result1 = pg_query("SELECT * from firedoor,firedoor_status WHERE (firedoor.date = 'now()' ) and (firedoor.name = firedoor_status.sname and firedoor_status.floor = 'ชั้น 4')");
        ...
        while ($row2 = pg_fetch_assoc($result2)) {
            ...
            if ($row22 == null) {
                ...
                if ($row2['status'] == 'on' && $row22['date'] ==  $Date_time) {
                    ...
                    echo "<div class='card-body'>";
                    echo "<img id='img' src='https://cdn0.iconfinder.com/data/icons/doors-filledoutline/64/FIRE_EXIT_DOOR-furniture_and_household-carpenter-house-home-128.png'><br><br>";
                    echo "<button type='button' id='change' class='w-100 btn btn-lg btn-danger'>" . $row2['status'] . "</button>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
        ...
        // ------------------------------------------------------------------ ชั้น 5 ------------------------------------------------------------------
        // $result1 = pg_query("SELECT * from firedoor,firedoor_status WHERE (firedoor.date = 'now()' ) and (firedoor.name = firedoor_status.sname and firedoor_status.floor = 'ชั้น 5')");
        ...
        while ($row3 = pg_fetch_assoc($result3)) {
            ...
            if ($row22 == null) {
                ...
                if ($row3['status'] == 'on' && $row33['date'] ==  $Date_time) {
                    ...
                    echo "<div class='card-body'>";
                    echo "<img id='img' src='https://cdn0.iconfinder.com/data/icons/doors-filledoutline/64/FIRE_EXIT_DOOR-furniture_and_household-carpenter-house-home-128.png'><br><br>";
                    echo "<button type='button' id='change' class='w-100 btn btn-lg btn-danger'>" . $row3['status'] . "</button>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
        ...
        // ------------------------------------------------------------------ ชั้น 6 ------------------------------------------------------------------
        // $result1 = pg_query("SELECT * from firedoor,firedoor_status WHERE (firedoor.date = 'now()' ) and (firedoor.name = firedoor_status.sname and firedoor_status.floor = 'ชั้น 6')");
        ...
        while ($row4 = pg_fetch_assoc($result4)) {
            ...
            if ($row44 == null) {
                ...
                if ($row4['status'] == 'on' && $row44['date'] ==  $Date_time) {
                    ...
                    echo "<div class='card-body'>";
                    echo "<img id='img' src='https://cdn0.iconfinder.com/data/icons/doors-filledoutline/64/FIRE_EXIT_DOOR-furniture_and_household-carpenter-house-home-128.png'><br><br>";
                    echo "<button type='button' id='change' class='w-100 btn btn-lg btn-danger'>" . $row4['status'] . "</button>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
        ...
        // ------------------------------------------------------------------ ชั้น 7 ------------------------------------------------------------------
        // $result1 = pg_query("SELECT * from firedoor,firedoor_status WHERE (firedoor.date = 'now()' ) and (firedoor.name = firedoor_status.sname and firedoor_status.floor = 'ชั้น 7')");
        ...
        while ($row5 = pg_fetch_assoc($result5)) {
            ...
            if ($row55 == null) {
                ...
                if ($row5['status'] == 'on' && $row55['date'] ==  $Date_time) {
                    ...
                    echo "<div class='card-body'>";
                    echo "<img id='img' src='https://cdn0.iconfinder.com/data/icons/doors-filledoutline/64/FIRE_EXIT_DOOR-furniture_and_household-carpenter-house-home-128.png'><br><br>";
                    echo "<button type='button' id='change' class='w-100 btn btn-lg btn-danger'>" . $row5['status'] . "</button>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
